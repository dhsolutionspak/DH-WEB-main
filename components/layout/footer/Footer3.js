        ...
        <>
            <footer className="footer footer-style-3">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 col-md-3 col-sm-12"><Link href="/"><img alt="Nivia" src="/assets/imgs/template/dhlogo-white.svg" /></Link>
                            <div className="mt-20 mb-20">
                                <p className="text-md neutral-600 mb-10">1309 Coffeen Ave Sheridan, Wyoming 82801</p>
                                <p className="text-md neutral-600">EIN : 36-5096941 </p>
                                <p className="text-md neutral-600">Hours: 8:00 - 17:00, Mon - Fri </p>
                    ...
                    <div className="footer-bottom mt-50">
                        <div className="row">
                            <div className="col-md-6 text-md-start text-center">
                                <p className="text-sm neutral-600">Copyright © 2024 DH Solutions LLC. All rights reserved.</p>
                            </div>
