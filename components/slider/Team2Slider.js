                ...
                <Swiper {...swiperOptions}>
                    <SwiperSlide>
                        <div className="card-team-2">
                            <div className="card-image"><img src="/assets/imgs/page/homepage2/mudassir-jaleel-pic.png" alt="Nivia" /></div>
                            <div className="card-info"><Link href="#">
                                <h6>Mudassir Jaleel</h6>
                            </Link>
                                <p className="text-lg neutral-600">Founder - CEO </p>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className="card-team-2">
                            <div className="card-image"><img src="/assets/imgs/page/homepage2/mohsin-jaleel-pic.png" alt="Nivia" /></div>
                            <div className="card-info"><Link href="#">
                                <h6>Mohsin Jaleel</h6>
                            </Link>
                                <p className="text-lg neutral-600">Co Founder - COO</p>
                            </div>
                        </div>
                    </SwiperSlide>
                </Swiper>
