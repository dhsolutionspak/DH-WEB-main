...
export default function Section10() {
    return (
        <>
            ...
            <section className="section-box box-latest-news">
                <div className="container">
                    <div className="row align-items-end">
                        <div className="col-lg-8 mb-30">
                            <h2 className="heading-2 mb-10">Latest News  Stories</h2>
                            <p className="text-lg neutral-700">Keep up with the newest advancements, success stories, and insights from DH Solutions.</p>
                        </div>
