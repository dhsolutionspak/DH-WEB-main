                    ...
                    <section className="section-box box-about-section-1">
                        <div className="container-fluid">
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-6">
                                    <div className="box-image-square"><img src="/assets/imgs/page/about/img-about.png" alt="Nivia" />
                                    </div>
                                </div>
                            </div>
                            <div className="row align-items-center">
                        ...
                        <div className="box-our-team-2-inner">
                            <div className="container">
                                <div className="text-center"><Link className="btn btn-brand-4-sm" href="#">Our people</Link>
                                    <h2 className="mb-20 mt-20">Meet Our C-Level Team</h2>
                            ...
                            <div className="row align-items-end">
                                ...
                                <div className="col-lg-8 mb-30">
                                    <div className="box-numbers">
                                        ...
                                        <div className="item-number">
                                            <h3 className="heading-2"><CounterUp count={7} />+</h3>
